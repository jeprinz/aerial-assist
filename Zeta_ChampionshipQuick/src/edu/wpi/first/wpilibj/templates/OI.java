...
import edu.wpi.first.wpilibj.templates.commands.shooter.DeFireBlocker;
import edu.wpi.first.wpilibj.templates.commands.shooter.FireBlocker;
...
public class OI {
    ...
    private JoystickButton blockerFire;
    private JoystickButton blockerRetract;
...
//        camera = AxisCamera.getInstance();     
        ...
        blockerFire = new JoystickButton(gamepad, 1);
        blockerFire.whenPressed(new FireBlocker());
        
        blockerRetract = new JoystickButton(gamepad, 3);
        blockerRetract.whenPressed(new DeFireBlocker());
    }
